...
#ifndef __SWIFT_BASE_RWSPINLOCK_H__
#define __SWIFT_BASE_RWSPINLOCK_H__
...
#if defined(__GNUC__) && (defined(__i386) || defined(__x86_64__) || defined(ARCH_K8))
...
* interfaces.
*/
class RWSpinLock : swift::noncopyable 
{
...
class RWTicketSpinLockT : swift::noncopyable 
{
...
public:
    ...
    */
    ...
    class ReadHolder : swift::noncopyable 
    {
    public:
        explicit ReadHolder (RWSpinLock *lock = nullptr) : lock_ (lock) 
        {
    ...
    class WriteHolder : swift::noncopyable 
    {
    public:
        explicit WriteHolder (RWSpinLock *lock = nullptr) : lock_ (lock) 
        {
...
#endif  // __SWIFT_BASE_RWSPINLOCK_H__
